...
class Result {
    ...
    // Write your code here
        SinglyLinkedListNode nhead = new SinglyLinkedListNode(head.data);
        nhead.next = null;
        SinglyLinkedListNode cur = head;
        SinglyLinkedListNode temp = nhead;
        while(cur != null){
            if(cur.data > temp.data){
                SinglyLinkedListNode new_node = new SinglyLinkedListNode(cur.data);
                temp.next = new_node;
                temp = new_node;
                temp.next = null;
            }
